    ...
    <body>
        ...
        <section>
          ...
          <div class="row">
                    ...
                    <div class="col-md-5 col-lg-3 col-xl-3">
                      <div class="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                        <img class="img-fluid w-100"
                          src="<?php echo "images/".$good['gpic']; ?>" alt="Sample">
                        <a href="#!">
                          <div class="mask">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                              ...
                              <button type="submit" class="card-link-secondary small text-uppercase mr-3"><i
                                ...
                                <br>
                            <a href="wishlist.php" type="button" class="card-link-secondary small text-uppercase"><i
                                class="fas fa-heart mr-1"></i> Move to wish list </a>

                                </form>
                          </div>
                          <p class="mb-0"><span><strong id="summary"><?php echo $good['gnum']*$good['gprice']; ?></strong></span></p class="mb-0">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <!--Grid column-->
            <div class="col-lg-4" id="platezhka">

              <!-- Card -->
              <div class="mb-2">
                <div class="pt-4">

                  <h5 class="mb-2">The total amount of</h5>
